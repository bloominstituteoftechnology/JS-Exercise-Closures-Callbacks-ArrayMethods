...
*/
function processLength(stringList, cb){
  return cb(stringList.length);
}
...
*/
function firstNamesAllCaps(runnerList) {
  return runnerList.map(runnerList => runnerList.first_name.toUpperCase());
}
