...
function isItAnApple(strings) {
   const newString = strings.map((boolean) => {
   if (boolean === 'apple')
   return true;
   else (boolean !== 'apple')
   return false;
...
function removeApple(strings) {
  return strings.filter(fruit => fruit !== 'apple');
}
 ...
 *    counter1 has a variable and a function nested inside of it. This function is different 
 * from counter 2 function because the nested function within can store and recall information
 * that was processed.
 * 
 * 2. Which of the two uses a closure? How can you tell?
 *    counter1 has a closure. I can tell because it has a nested function which accessed a variable 
 * outside of it.
 * 
 * 3. In what scenario would the counter1 code be preferable? In what scenario would counter2 be better? 
 *   counter1 would be preferable if you ......////////
*/
