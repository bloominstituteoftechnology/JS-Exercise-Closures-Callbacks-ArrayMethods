...
function stringSmash(strings) {
  return strings.reduce((accum, string) => {
    return accum + string;
  });
};
...
function tallyUpDonations(runners) {
  return runners.reduce((accum, runner) => accum + runner.donation, 0);
}
...
*  I think Counter 1 uses a closure. Because the counter function relies on the count variable defined outside of it
